      ...
      <div className={classes.root} >
        <AppBar position="static" style={{ background: '#FFFFFF' }}>
          <Toolbar>
            ...
            <Button variant="contained" color="inherit"><NavLink to='/'>Become A Host</NavLink></Button>
            <Button color="inherit"><NavLink to='/help'>Help</NavLink></Button>
            <Button color="inherit"><NavLink to='/signup'>Sign Up</NavLink></Button>
            <Button color="inherit"><NavLink to='/login'>Log In</NavLink></Button>
            </div>
          </Toolbar>
        </AppBar>
        {renderMenu}
